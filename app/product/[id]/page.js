...
const ProductDetail = ({ label, value }) => {
  return (
    <>
      <h5 className="text-[#767676] uppercase text-[12px] md:text-[1.1rem] lg:text-[1.5rem]">
        {label}
      </h5>
      <h3 className="uppercase font-inter text-[13px] md:text-[1.3rem] lg:text-[1.7rem] font-medium">
        {value}
      </h3>
    </>
  );
    ...
    <main>
      ...
      <section className="container mx-auto mt-[50px] px-[15px] text-primary">
        <div className="grid grid-cols-2 gap-4 relative">
          ...
          <div className="flex justify-end gap-2 text-center absolute top-0 right-0 md:static md:justify-center">
          ...
          <div className="fixed bottom-0 left-0 md:static md:items-center md:py-0 md:h-full flex flex-col justify-center gap-2 w-full bg-[#fff] z-20 py-6 ">
            <button
            ...
            <Link
              href="/catalogue"
              className="uppercase rounded-[40px] bg-primary text-[#fff] text-[14px] px-[18px] py-[14px] mx-auto"
            >
          ...
          <div className="flex items-end cursor-pointer col-span-full">
            <Link
              ...
              className="underline text-[#1128F8] text-[13px] md:text-[1.3rem] lg:text-[1.7rem]"
            >
              Click to view
            </Link>
            <div className="ml-2">
              <Image
                ...
                width="56"
                height="56"
                className="w-[20px] h-[20px] md:w-[28px] md:h-[28px] lg:w-[38px] lg:h-[38px]"
              />
            </div>
          </div>
          ...
          <div className="col-span-full">
            <p className="text-[13px] md:text-[1.3rem] lg:text-[1.7rem]">
              {product.description}
            </p>
          </div>
